  ...
  handler: async (ctx) => {
    const standards: SeedCompetencyStandard[] = [
      ...
      },
      {
        ...
        studentFriendlyDescription: "I can create equations to model real-world situations.",
        category: "Algebra",
        isActive: true,
      },
      {
      ...
      {
        code: "HSF-IF.C.7c",
        description: "Graph polynomial functions, showing intercepts, end behavior, and turning points",
      ...
      },
      {
        ...
        studentFriendlyDescription: "I can write functions that describe relationships between quantities.",
        category: "Functions",
        isActive: true,
      },
      {
        code: "HSF-LE.A.2",
        description: "Construct and compare exponential, logarithmic, and linear models and solve problems",
        studentFriendlyDescription: "I can compare linear, exponential, and logarithmic models.",
        category: "Functions",
        isActive: true,
      },
      {
        code: "HSF-LE.B.5",
        description: "Interpret the parameters in an exponential or logarithmic function in terms of a context",
        studentFriendlyDescription: "I can interpret what exponential and logarithmic parameters mean.",
        category: "Functions",
        isActive: true,
      },
    ];
