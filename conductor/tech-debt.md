...
| 2026-04-13 | component-approval | No auth checks in convex/dev.ts internal functions | Medium | Open | Phase 3 will add developer-only access guard; current functions rely entirely on caller trust |
