...
| class_lessons table empty — chatbot falls back to open enrollment | High | Open | Fallback added in review #12; proper seeding needed when teacher assignment UI exists |
