...
- [ ] Task: Verify lesson 9-1 curriculum source
  - [ ] Confirm title and phase sequence against `curriculum/modules/module-9-lesson-1`
  - [ ] Confirm degree, radian, and arc-length notation renders correctly
- [ ] Task: Create seed function `convex/seed/seed-lesson-9-1.ts`
  - [ ] Write tests for phase sequence and idempotency
  - [ ] Implement lesson, phases, sections, and activities
- [ ] Task: Conductor - Phase Completion Verification 'Seed Lesson 9-1' (Protocol in workflow.md)
