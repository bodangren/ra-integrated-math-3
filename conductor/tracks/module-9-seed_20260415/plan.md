...
- [x] Task: Verify lesson 9-1 curriculum source
...
- [x] Task: Create seed function `convex/seed/seed-lesson-9-1.ts`
  - [x] Write tests for phase sequence and idempotency
  - [x] Implement lesson, phases, sections, and activities
- [x] Task: Conductor - Phase Completion Verification 'Seed Lesson 9-1' (Protocol in workflow.md)
