...
- [ ] Task: Verify lesson 8-1 curriculum source
  - [ ] Confirm title and phase sequence against `curriculum/modules/module-8-lesson-1`
  - [ ] Confirm random sampling examples preserve bias and representativeness
- [ ] Task: Create seed function `convex/seed/seed-lesson-8-1.ts`
  - [ ] Write tests for phase sequence and idempotency
  - [ ] Implement lesson, phases, sections, and activities
- [ ] Task: Conductor - Phase Completion Verification 'Seed Lesson 8-1' (Protocol in workflow.md)
