...
import { getGlossaryTermsByModule, getAllGlossaryModules } from '@/lib/study/glossary';
...
export default function FlashcardsPage() {
  const allTerms = getGlossaryTermsByModule(1);
  const moduleNumbers = getAllGlossaryModules();

  return (
    <FlashcardsPageClient allTerms={allTerms} moduleNumbers={moduleNumbers} />
  );
}