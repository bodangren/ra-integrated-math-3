...
- `measure/monorepo-plan.md` (strategy and constraints)
- `measure/monorepo-track-playbook.md` (workflow and sequencing)
- each track folder `spec.md` + `plan.md` (Measure acceptance criteria)
...
- `measure/tracks/monorepo-readiness_20260417/*`
- `measure/tracks.md`
- `measure/monorepo-plan.md` (if decision clarifications are needed)
- create `measure/monorepo-migration-index.md`
...
Decision-required (document in readiness): whether `measure/` remains root-owned for monorepo governance.
...
rg -n "apps/integrated-math-3|apps/bus-math-v2" "$MONO_ROOT/measure" "$MONO_ROOT/README.md" "$MONO_ROOT/INTEGRATION.md"
```
