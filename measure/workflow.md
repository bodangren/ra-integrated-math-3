...
12. **Commit Plan Update:**
    ...
    - Commit this change with a descriptive message (e.g., `measure(plan): Mark task 'Create user model' as complete`).
...
6. **Create Checkpoint Commit:**
   - `git commit -m "measure(checkpoint): Checkpoint end of Phase X"`
...
9. **Commit Plan Update:** `measure(plan): Mark phase '<PHASE NAME>' as complete`
...
- `measure`: Measure framework operations
