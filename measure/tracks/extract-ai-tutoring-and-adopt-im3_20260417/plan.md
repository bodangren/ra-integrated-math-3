...
> Execution detail packet: see `measure/monorepo-jr-execution-spec.md`, section `extract-ai-tutoring-and-adopt-im3_20260417`.
...
- [x] **Task: Measure - User Manual Verification 'Phase 1: Package Extraction from BM2' (Protocol in workflow.md)**
...
- [ ] **Task: Measure - User Manual Verification 'Phase 3: IM3 Adoption and Completion' (Protocol in workflow.md)**
