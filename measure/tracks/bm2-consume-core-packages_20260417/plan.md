...
> Execution detail packet: see `measure/monorepo-jr-execution-spec.md`, section `bm2-consume-core-packages_20260417`.
...
- [x] **Task: Measure - User Manual Verification 'Phase 1: Practice and SRS Adoption' (Protocol in workflow.md)**
...
- [x] **Task: Measure - User Manual Verification 'Phase 2: Auth and Convex Adoption' (Protocol in workflow.md)**
...
- [x] **Task: Measure - User Manual Verification 'Phase 3: Cleanup and Verification' (Protocol in workflow.md)**
