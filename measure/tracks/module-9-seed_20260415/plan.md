...
- [x] Task: Measure - Phase Completion Verification 'Seed Lesson 9-1' (Protocol in workflow.md) [13f8649]
...
- [x] Task: Create seed function `convex/seed/seed-lesson-9-2.ts` [ec08cc8]
  - [x] Write tests for phase sequence and idempotency
  - [x] Implement lesson, phases, sections, and activities
- [x] Task: Measure - Phase Completion Verification 'Seed Lesson 9-2' (Protocol in workflow.md) [ec08cc8]
...
- [x] Task: Create seed function `convex/seed/seed-lesson-9-3.ts` [cfd278b]
  - [x] Write tests for phase sequence and idempotency
  - [x] Implement lesson, phases, sections, and activities
- [x] Task: Measure - Phase Completion Verification 'Seed Lesson 9-3' (Protocol in workflow.md) [cfd278b]
...
- [x] Task: Create seed function `convex/seed/seed-lesson-9-4.ts` [c86a487]
  - [x] Write tests for phase sequence and idempotency
  - [x] Implement lesson, phases, sections, and activities
- [x] Task: Measure - Phase Completion Verification 'Seed Lesson 9-4' (Protocol in workflow.md) [c86a487]

## Phase 5: Seed Lesson 9-5 [checkpoint: eb337e4]
...
- [x] Task: Create seed function `convex/seed/seed-lesson-9-5.ts`
  - [x] Write tests for phase sequence and idempotency
  - [x] Implement lesson, phases, sections, and activities
- [x] Task: Measure - Phase Completion Verification 'Seed Lesson 9-5' (Protocol in workflow.md)
...
- [x] Task: Create seed function `convex/seed/seed-lesson-9-6.ts` [e481132]
  - [x] Write tests for phase sequence and idempotency
  - [x] Implement lesson, phases, sections, and activities
- [x] Task: Measure - Phase Completion Verification 'Seed Lesson 9-6' (Protocol in workflow.md) [e481132]
...
- [x] Task: Create seed function `convex/seed/seed-lesson-9-7.ts` [7613463]
  - [x] Write tests for phase sequence and idempotency
  - [x] Implement lesson, phases, sections, and activities
- [x] Task: Measure - Phase Completion Verification 'Seed Lesson 9-7' (Protocol in workflow.md) [7613463]
...
- [x] Task: Add Module 9 standards
  - [x] Identify standard codes from curriculum/source mapping
  - [x] Add standards and lesson-standard links with tests
...
- [x] Task: Update Measure status
  - [x] Mark completed phases in this plan
  - [x] Update `measure/tracks.md` and `measure/current_directive.md`
- [x] Task: Measure - Phase Completion Verification 'Module Integration and Verification' (Protocol in workflow.md) [f9fb717]
