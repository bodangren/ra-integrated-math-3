...
- [ ] **Task: Measure - User Manual Verification 'Phase 1: Package Setup and Common File Extraction' (Protocol in workflow.md)**
...
- [ ] **Task: Measure - User Manual Verification 'Phase 2: `server.ts` Reconciliation' (Protocol in workflow.md)**
...
- [ ] **Task: Measure - User Manual Verification 'Phase 3: IM3 Migration and Verification' (Protocol in workflow.md)**
