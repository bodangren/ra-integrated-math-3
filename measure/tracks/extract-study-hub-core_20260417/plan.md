...
> Execution detail packet: see `measure/monorepo-jr-execution-spec.md`, section `extract-study-hub-core_20260417`.
...
- [x] **Task: Measure - User Manual Verification 'Phase 1: Extract Shared Study Primitives' (Protocol in workflow.md)**
...
- [ ] **Task: Measure - User Manual Verification 'Phase 2: Adopt in Both Apps' (Protocol in workflow.md)**
...
- [ ] **Task: Measure - User Manual Verification 'Phase 3: Verification and Cleanup' (Protocol in workflow.md)**
