...
- [ ] **Task: Measure - User Manual Verification 'Phase 1: Extract Shared Convex Wrappers' (Protocol in workflow.md)**
...
- [ ] **Task: Measure - User Manual Verification 'Phase 2: Adapter API for Generated Modules' (Protocol in workflow.md)**
...
- [ ] **Task: Measure - User Manual Verification 'Phase 3: IM3 Adoption and Verification' (Protocol in workflow.md)**
