...
- [x] Measure - User Manual Verification 'Phase 1' (Protocol in workflow.md)
...
- [x] Measure - User Manual Verification 'Phase 2' (Protocol in workflow.md)
...
- [x] Measure - User Manual Verification 'Phase 3' (Protocol in workflow.md)
...
- [x] Measure - User Manual Verification 'Phase 4' (Protocol in workflow.md)
...
- [x] Measure - User Manual Verification 'Phase 5' (Protocol in workflow.md) [checkpoint: cbae9ca]
...
- [x] Measure - User Manual Verification 'Phase 6' (Protocol in workflow.md)
...
- [x] Measure - User Manual Verification 'Phase 7' (Protocol in workflow.md)
...
- [x] Measure - User Manual Verification 'Phase 8' (Protocol in workflow.md)
