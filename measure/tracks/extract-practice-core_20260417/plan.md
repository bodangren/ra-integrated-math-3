...
> Execution detail packet: see `measure/monorepo-jr-execution-spec.md`, section `extract-practice-core_20260417`.
...
- [x] **Task: Measure - User Manual Verification 'Phase 1: Scaffold and Extract' (Protocol in workflow.md)**
...
- [x] **Task: Measure - User Manual Verification 'Phase 2: Reconcile BM2 Deltas' (Protocol in workflow.md)**
...
- [x] **Task: Measure - User Manual Verification 'Phase 3: IM3 Import Migration and Verification' (Protocol in workflow.md)**
