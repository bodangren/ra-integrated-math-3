...
This roadmap keeps the remaining Integrated Math 3 curriculum work visible after Module 2. Each module has complete curriculum source files under `curriculum/modules/` and a Measure seed track under `measure/tracks/`.
...
6. After Module 9, begin the Daily Practice SRS roadmap in `measure/daily-practice-srs-roadmap.md`.

## Module Inventory

| Module | Topic | Lessons | Track |
|--------|-------|---------|-------|
| 3 | Polynomial Equations | 5 | `measure/tracks/module-3-seed_20260415/` |
| 4 | Inverses and Radical Functions | 6 | `measure/tracks/module-4-seed_20260415/` |
| 5 | Exponential Functions and Geometric Series | 5 | `measure/tracks/module-5-seed_20260415/` |
| 6 | Logarithmic Functions | 5 | `measure/tracks/module-6-seed_20260415/` |
| 7 | Rational Functions and Equations | 6 | `measure/tracks/module-7-seed_20260415/` |
| 8 | Inferential Statistics | 5 | `measure/tracks/module-8-seed_20260415/` |
| 9 | Trigonometric Functions | 7 | `measure/tracks/module-9-seed_20260415/` |
...
7. Update `measure/tracks.md`, `measure/current_directive.md`, and the track plan before completion.
...
1. `measure/tracks/practice-timing-telemetry_20260415/`
2. `measure/tracks/practice-timing-baselines_20260415/`

See `measure/daily-practice-srs-roadmap.md` for the broader reusable SRS sequence.
