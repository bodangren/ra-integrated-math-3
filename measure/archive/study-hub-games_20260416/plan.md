...
- [x] **Task: Measure - User Manual Verification 'Phase 1' (Protocol in workflow.md)** [f88c7e3]
...
- [x] **Task: Measure - User Manual Verification 'Phase 2' (Protocol in workflow.md)** [ba144e0]
...
- [x] **Task: Measure - User Manual Verification 'Phase 3' (Protocol in workflow.md)** [phase3-verify]
