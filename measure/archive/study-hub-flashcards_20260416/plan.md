...
- [x] **Task: Measure - User Manual Verification 'Phase 1' (Protocol in workflow.md)** [checkpoint: c47f8a1]
...
- [x] **Task: Measure - User Manual Verification 'Phase 2' (Protocol in workflow.md)** [checkpoint: 858be16]
...
- [x] **Task: Measure - User Manual Verification 'Phase 3' (Protocol in workflow.md)** [checkpoint: 47afac5]
