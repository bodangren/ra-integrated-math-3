...
> Execution detail packet: see `measure/monorepo-jr-execution-spec.md`, section `move-bm2-app-to-apps_20260417`.
...
- [x] **Task: Measure - User Manual Verification 'Phase 1: Mechanical BM2 Move' (Protocol in workflow.md)**
...
- [x] **Task: Measure - User Manual Verification 'Phase 2: Config and Workflow Updates' (Protocol in workflow.md)**
...
- [x] **Task: Measure - User Manual Verification 'Phase 3: Cross-App Verification' (Protocol in workflow.md)** [checkpoint: 18a7f3c]