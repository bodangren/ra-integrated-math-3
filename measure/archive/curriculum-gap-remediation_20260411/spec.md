...
- `measure/course-objectives.md` defines 105 objectives.
...
3. Use existing or planned component keys from `measure/practice-component-contract.md`.
...
14. Measure docs and curriculum docs are synchronized with the final artifact layout.
