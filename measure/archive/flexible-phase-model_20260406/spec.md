...
7. Update `measure/product.md` to replace references to "6-phase lessons" with "variable-length, typed phase sequences."

8. Update `measure/architecture.md` curriculum hierarchy to show the flexible model.
