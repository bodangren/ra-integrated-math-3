...
> Execution detail packet: see `measure/monorepo-jr-execution-spec.md`, section `extract-core-auth-convex_20260417`.
...
- [x] **Task: Measure - User Manual Verification 'Phase 1: Package Scaffolding and Baseline Extraction' (Protocol in workflow.md)**
...
- [x] **Task: Measure - User Manual Verification 'Phase 2: Reconcile Divergent Auth/Convex Logic' (Protocol in workflow.md)**
...
- [x] **Task: Measure - User Manual Verification 'Phase 3: IM3 Migration, Verification, and Handoff' (Protocol in workflow.md)**
