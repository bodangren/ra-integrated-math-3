...
If an environment flag is introduced, default it to disabled for production and document the behavior in `measure/tech-stack.md` only if the implementation adds a new required environment variable.
