...
> Execution detail packet: see `measure/monorepo-jr-execution-spec.md`, section `extract-practice-test-engine_20260417`.
...
- [ ] **Task: Measure - User Manual Verification 'Phase 2: App Adoption' (Protocol in workflow.md)**
