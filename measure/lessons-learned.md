...
- (2026-04-29, chatbot-prompt-guard) Prompt injection defense requires layered approach: (1) system message separation prevents instruction blending, (2) pattern-based detection catches common attacks before LLM call, (3) generic error messages don't reveal defense mechanisms. Use createOpenRouterProviderWithMessages for proper system/user role separation.
